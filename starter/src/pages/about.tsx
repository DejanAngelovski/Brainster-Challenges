...
const About: NextPage<Props> = ({ aboutData }) => {
  const { author, fifth_content, first_content, first_image, fourth_content, second_content, second_image, second_title, third_content, title } = aboutData
  return (
    <>
      <Head>
...
export const getStaticProps: GetStaticProps = async () => {
  const aboutDataRes = await fetch('https://jolly-cute-centaur.glitch.me/about_page')
